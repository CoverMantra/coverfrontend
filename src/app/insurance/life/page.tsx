...
export default function LifeInsurancePage() {
  ...
  return (
    <>
      <Head>
        <title>Life Insurance | Secure Your Legacy</title>
      </Head>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <div className="relative bg-white border border-gray-100 rounded-[3rem] p-8 md:p-12 shadow-xl overflow-hidden" data-aos="fade-right">
              ...
              <ul className="space-y-4 relative z-10">
                {[
                  "Government ID ([Aadhaar Redacted])", "Proof of Residence", "Income Statements", 
