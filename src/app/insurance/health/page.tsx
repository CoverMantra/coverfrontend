...
// Assuming these are local components/files
...
export default function HealthInsurancePage() {
  ...
  return (
    <>
      <Head>
        <title>Health Insurance | YourBank Premium</title>
      </Head>
      ...
      <main className="min-h-screen bg-[#FFF4E5] text-[#08101E] overflow-x-hidden">
        ...
        {/* 📑 DOCUMENTS & BENEFITS - Split Glass Layout */}
