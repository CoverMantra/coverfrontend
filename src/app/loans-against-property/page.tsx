...
import { ArrowLeft, Building, ShieldCheck, CheckCircle } from "lucide-react";

export default function LoanAgainstPropertyComingSoon() {
      ...
      <div className="max-w-4xl mx-auto w-full z-10">
        ...
        <div className="text-center md:text-left flex flex-col md:flex-row items-center gap-8 pb-12 border-b border-white/5">
          <div className="w-24 h-24 sm:w-28 sm:h-28 bg-[#FF690B]/10 rounded-[2rem] flex items-center justify-center text-[#FF690B] border border-[#FF690B]/20 shadow-lg shadow-[#FF690B]/5 shrink-0">
            <Building size={48} className="animate-pulse" />
          </div>
          <div>
            ...
            <p className="text-white/60 text-lg max-w-2xl leading-relaxed">
              Unlock the value of your commercial or residential property. We are currently integrating with top banks and financial institutions to bring you custom Loan Against Property options with lowest interest rates, minimal paperwork, and quick digital approval.
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 mt-12 items-start">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4">
              {[
                { title: "High Loan Amount", desc: "Unlock high capital values from your real estate." },
                { title: "Low Interest Rates", desc: "Lower rates than standard personal/unsecured loans." },
                { title: "Long Tenures", desc: "Extended repayment timelines to keep your EMIs light." },
                { title: "Residential & Commercial", desc: "Finance against any type of approved residential or commercial property." }
              ].map((highlight, index) => (
            ...
            {submitted ? (
              <div className="text-center py-8">
                ...
                <p className="text-xs text-white/50 mt-2 max-w-xs mx-auto">
                  We have registered your interest. Our finance team will notify you as soon as Loan Against Property goes live.
                </p>
              </div>
            ) : (
              <div>
