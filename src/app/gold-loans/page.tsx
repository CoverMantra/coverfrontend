...
import { ArrowLeft, Coins, ShieldCheck, CheckCircle } from "lucide-react";

export default function GoldLoansComingSoon() {
        ...
        <div className="text-center md:text-left flex flex-col md:flex-row items-center gap-8 pb-12 border-b border-white/5">
          ...
          <div>
            ...
            <p className="text-white/60 text-lg max-w-2xl leading-relaxed">
              Unlock the value of your gold jewelry. We are currently integrating with top banks and financial institutions to bring you custom Gold Loan products with lowest interest rates, minimal paperwork, and quick digital approval.
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 mt-12 items-start">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4">
              {[
                { title: "High Valuation", desc: "Get maximum loan value against your gold ornaments." },
                { title: "Low Interest Rates", desc: "Industry best interest rates to keep your EMI burden low." },
                { title: "Safe Storage", desc: "Highly secured vaults with free insurance for your valuable gold." },
                { title: "Flexible Tenure", desc: "Repayment options that suit your cashflow and needs." }
              ].map((highlight, index) => (
            ...
            {submitted ? (
              <div className="text-center py-8">
                ...
                <p className="text-xs text-white/50 mt-2 max-w-xs mx-auto">
                  We have registered your interest. Our finance team will notify you as soon as Gold Loans go live.
                </p>
              </div>
            ) : (
              <div>
