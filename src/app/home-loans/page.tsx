...
import { ArrowLeft, Home, ShieldCheck, CheckCircle } from "lucide-react";

export default function HomeLoansComingSoon() {
        ...
        <div className="text-center md:text-left flex flex-col md:flex-row items-center gap-8 pb-12 border-b border-white/5">
          ...
          <div>
            ...
            <p className="text-white/60 text-lg max-w-2xl leading-relaxed">
              We are currently integrating with top banks and financial institutions to bring you custom Home Loan products with lowest interest rates, minimal paperwork, and quick digital approval.
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 mt-12 items-start">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4">
              {[
                { title: "Lowest Interest Rates", desc: "Access home financing starting from industry-best interest rates." },
                { title: "Flexible Repayment", desc: "Repayment tenures spanning up to 30 years to ease your budget." },
                { title: "Digital First Process", desc: "Upload docs and track approval status 100% online." },
                { title: "Zero Hidden Fees", desc: "Complete transparency in processing charges and foreclosure." }
              ].map((highlight, index) => (
            ...
            {submitted ? (
              <div className="text-center py-8">
                ...
                <p className="text-xs text-white/50 mt-2 max-w-xs mx-auto">
                  We have registered your interest. Our finance team will notify you as soon as Home Loans go live.
                </p>
              </div>
            ) : (
              <div>
