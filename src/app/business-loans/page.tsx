  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#FFF4E5] text-[#08101E] font-sans selection:bg-[#FF7819]/30 overflow-x-hidden">
        ...
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-[#08101E] text-white py-20 px-4">
          ...
          <div className="relative max-w-6xl mx-auto text-center z-10">
            ...
            <motion.p
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="text-lg md:text-xl mb-16 text-gray-400 max-w-3xl mx-auto font-medium"
            >
        ...
        {/* 💎 TYPES SECTION — Bento Grid Style */}
        ...
        {/* 🏆 WHY CHOOSE US — 3D Floating Cards */}
...
// Add a simple FaPaperPlane icon or import it from react-icons/fa
